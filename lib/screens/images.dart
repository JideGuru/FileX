...
class Images extends StatelessWidget {
    ...
    return Consumer(
      builder: (BuildContext context, CategoryProvider provider, Widget child) {
        return provider.loading
            ...
            : buildBody(provider, context);
      },
    );
  }

  buildBody(CategoryProvider provider, BuildContext context) {
            ...
            : TabBarView(
                children: Constants.map<Widget>(
                  ...
                  (index, label) {
                    ...
                    return buildFileList(index, provider, l);
                  },
                ),
              ),
      ),
  ...
  buildFileList(int index, CategoryProvider provider, List list) {
        ...
        SliverPadding(
          ...
          sliver: SliverGrid.count(
            ...
            children: Constants.map(
              index == 0 ? provider.images : list.reversed.toList(),
              (index, item) {
